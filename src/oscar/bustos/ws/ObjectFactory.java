 ...
 * generated in the oscar.bustos.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Suma_QNAME = new QName("http://ws.bustos.oscar/", "suma");
    private final static QName _SumaResponse_QNAME = new QName("http://ws.bustos.oscar/", "sumaResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: oscar.bustos.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bustos.oscar/", name = "suma")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.bustos.oscar/", name = "sumaResponse")
